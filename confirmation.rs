...
const CANISTER_COLLECTIONS: [[&str; REPLICA_NUM]; COLLECTION_SIZE] = unimplemented!(); // custom storage canisters
const DEFAULT_OWNER: &str = unimplemented!(); // custom owner
...
impl Default for Config {
    fn default() -> Self {
        ...
        Self {
            ...
            da_canisters,
            owner: Principal::from_text("").unwrap(),
        }
    }
}
